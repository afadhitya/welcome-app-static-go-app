...
// Create a struct that hodls information to be displayed in our HTML file
type Welcome struct {
	Name string
	Time string
}
...
// Go App entrypoint
func main() {
	// Instantiate a Welcome struct obj and pass in some random infomation.
	// We shall get the name of the user as a query param from the URL
	...
	// html can refger to when looking for our css and other files.
	...
	http.HandleFunc("/", func(w http.ResponseWriter, r *http.Request) {
		...
		//Of errprs show an internal server error message
